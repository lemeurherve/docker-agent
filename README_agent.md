...
```powershell
docker run -i --rm --name agent --init jenkins/agent:jdk25-windowsservercore-ltsc2022 java -jar C:/ProgramData/Jenkins/agent.jar
```
...
```powershell
docker run -i --rm --name agent1 --init -v agent1-workdir:C:/Users/jenkins/Work jenkins/agent:jdk25-windowsservercore-ltsc2022 java -jar C:/ProgramData/Jenkins/agent.jar -workDir C:/Users/jenkins/Work
```
